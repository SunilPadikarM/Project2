...
namespace HotelReservation.Controllers
{
    public class CardDetailsController : Controller
    {
        ...
        public ActionResult MakePayment(CardDetail cardDetail)
        {
            ...
            reservation.ID = (int)Session["UserId"];
            ...
            webservice.createTransaction(reservation.ReservationNumber, cardDetail.NameOnCard, cardDetail.CardNumber, double.Parse(room.Price.ToString()), Convert.ToInt32(((DateTime)reservation.CheckOutDate - (DateTime)reservation.CheckInDate).TotalDays), double.Parse(room.Price.ToString()), cardDetail.ExpDate, cardDetail.CardType);
            return View("../Reservations/SearchRooms");
        }
